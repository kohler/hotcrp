...
class Icons {
    // magnifier shared by the zoom icons: lens ring centered (25,25), outer
    // radius 20 and inner 17 for a 3u ring against the set's 3.0u pen, and a
    // handle 8u wide running out to the lower right
    const ZOOM_LENS = 'M5 25A20 20 0 0 1 45 25A20 20 0 0 1 5 25ZM8 25A17 17 0 0 0 42 25A17 17 0 0 0 8 25ZM40.8 35.2L58.8 53.2L53.2 58.8L35.2 40.8Z';
    ...
    static function svg_contents($name) {
        ...
        case "copy":
            return '<path d="M40 21L40 11A5 5 0 0 0 35 6L11 6A5 5 0 0 0 6 11L6 35A5 5 0 0 0 11 40L21 40L21 37L11 37A2 2 0 0 1 9 35L9 11A2 2 0 0 1 11 9L35 9A2 2 0 0 1 37 11L37 21ZM29 24L53 24A5 5 0 0 1 58 29L58 53A5 5 0 0 1 53 58L29 58A5 5 0 0 1 24 53L24 29A5 5 0 0 1 29 24ZM27 29L27 53A2 2 0 0 0 29 55L53 55A2 2 0 0 0 55 53L55 29A2 2 0 0 0 53 27L29 27A2 2 0 0 0 27 29Z" />';
        case "eye":
        ...
        case "upload":
            // arrow rising out of a 40u tray with 14u sides; a 4.0u pen rather
            // than the set's 3.0u, since two strokes alone read light beside
            // the denser icons
            return '<path fill="none" stroke-width="4" d="M12 37V51H52V37M19 20L32 8L45 20M32 8V41" />';
        case "attachment":
        ...
        case "zoom_in":
            return '<path d="' . self::ZOOM_LENS . 'M14 22.5H36V27.5H14ZM22.5 14H27.5V36H22.5Z" />';
        case "zoom_out":
            return '<path d="' . self::ZOOM_LENS . 'M14 22.5H36V27.5H14Z" />';

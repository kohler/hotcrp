...
let has_unload = false, last_visibility = null, last_topic = null, my_last_topic = false,
...
function cmt_start_edit(celt, cj) {
    ...
    const new_topic = last_topic || (document.querySelector(".revcard.revsubmitted") ? "rev" : "paper"),

...
class Sround_SettingParser extends SettingParser {
    ...
    private static function print_round($sv, $ctr) {
        ...
        echo '<legend>', $sv->label($namesi->name, "Submission class"), ' &nbsp;',
            ...
            Ht::button(Ht::make_licon("trash", "m"), ["name" => "submission/{$ctr}/deleter", "class" => "ui js-settings-submission-round-delete ml-2 btn-licon-s need-tooltip", "aria-label" => "Delete submission class", "tabindex" => -1]);

...
class DecisionVisibility_SettingParser extends SettingParser {
    ...
    static function print_author(SettingValues $sv) {
        echo '<p class="hidden feedback is-note mb-3 js-if-decision-desk-reject">Decisions in the desk-reject category are always visible to authors and reviewers.</p>';

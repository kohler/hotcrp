...
class Messages_SettingRenderer {
    static function render(SettingValues $sv) {
        ...
        $sv->echo_message("msg.clickthrough_submit", "Clickthrough submission terms",
                   "<div class=\"hint fx\">Users must “accept” these terms to edit a submission. Use HTML and include a headline, such as “&lt;h2&gt;Submission terms&lt;/h2&gt;”.</div>");
        $sv->echo_message("msg.submit", "Submission message",
                   "<div class=\"hint fx\">This message will appear on submission editing pages.</div>");

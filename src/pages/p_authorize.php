    ...
    private function handle_authconfirm() {
        ...
        if (isset($this->client->allow_if)
            ...
            $this->conf->feedback_msg(
                MessageItem::error("<0>User {} is not authorized to authenticate with {}", new FmtArg(0, $this->viewer->email, 0), new FmtArg(1, $this->client->title_text(), 0)),
            ...
            if ($this->cs) {
                ...
                JsonResult::make_minimal(401, ["error" => "invalid_grant"])->complete();
            }
        }

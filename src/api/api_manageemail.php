    ...
    private function run_transferpc() {
        ...
        if ($this->dstuser->has_review()) {
            ...
            if (!$ps->is_empty()) {
                ...
                $this->inform_at("email", "<5>PC information for {0} can’t be transferred to {1} because there are {submissions} for which both accounts have reviews.", $this->user->email, $this->dstuser->email);

...
-- default review form
insert into Settings (name, value, data) values ('review_form',1,'{"overAllMerit":{"name":"Overall merit","position":1,"visibility":"author","options":["Reject","Weak reject","Weak accept","Accept","Strong accept"]},"reviewerQualification":{"name":"Reviewer expertise","position":2,"visibility":"author","options":["No familiarity","Some familiarity","Knowledgeable","Expert"]},"suitableForShort":{"name":"Suitable for short paper","visibility":"author","options":["Not suitable","Can''t tell","Suitable"]},"paperSummary":{"name":"Paper summary","position":3,"display_space":5,"visibility":"author"},"commentsToAuthor":{"name":"Comments for author","position":4,"display_space":15,"visibility":"author"},"commentsToPC":{"name":"Comments for PC","position":5,"display_space":10,"visibility":"pc"}}');

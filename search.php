...
if ($pl) {
    ...
    if ($pl->anySelector)
	echo "<form method='post' action=\"", htmlspecialchars(selfHref(array("selector" => 1), "search$ConfSiteSuffix")), "\" accept-charset='UTF-8' id='sel' onsubmit='return paperselCheck();'>\n",

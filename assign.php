...
if ($Me->amAssistant()) {
  ...
  <td class='entry'><table class='pcass'><tr><td><table>\n";
	...
	if ($p->author > 0) {
	    ...
	    echo "<select id='pcs", $p->contactId, "' name='pcs", $p->contactId, "' class='extension' size='4' onchange='selassign(this, $p->contactId)' onclick='selassign(null, $p->contactId)' onblur='setTimeout(\"selassign(null, $p->contactId)\", 1)' style='position: absolute'>

...
xassert_eqq($am->search("elan"), [1]);
xassert_eqq($am->search("el"), [1]);
xassert_eqq($am->search("él"), [1]);
xassert_eqq($am->search("ÉL"), [1]);
xassert_eqq($am->search("e"), [1, 2]);
xassert_eqq($am->search("ecla"), [2]);
xassert_eqq($am->search("should-the-pc-suck"), [3]);
xassert_eqq($am->search("should-the pc-suck"), [3]);
xassert_eqq($am->search("ShoPCSuc"), [3]);
xassert_eqq($am->search("ShoPCRoc"), [4]);
$am->add("élan", 5, 2);
xassert_eqq($am->search("elan"), [1, 5]);
xassert_eqq($am->search("elan", 1), [1]);
xassert_eqq($am->search("elan", 2), [5]);
xassert_eqq($am->search("elan", 3), [1, 5]);
xassert_eqq($am->search("é"), [1, 5]);
$am->add("élange", 6, 2);
xassert_eqq($am->search("ela"), [1, 5, 6]);
xassert_eqq($am->search("elan"), [1, 5]);
xassert_eqq($am->search("elange"), [6]);
xassert_eqq($am->search("elan*"), [1, 5, 6]);
xassert_eqq($am->search("e*e"), [6]);
...
xassert_eqq($am->search("OveMer"), [1]);
xassert_eqq($am->search("merit overall"), []);

$am->add("PC Person", 5);
$am->add("PC Person 2", 6);
$am->add("P. C. Person 3", 7);
$am->add("P. C. Person 20", 8);
xassert_eqq($am->search("PCPer"), [5]);
xassert_eqq($am->search("PCPer2"), [6]);
xassert_eqq($am->search("PCPer3"), [7]);
xassert_eqq($am->search("PCPer20"), [8]);

...
// MentionParser checks
$pcm = $Conf->pc_members();
$mpxs = iterator_to_array(MentionParser::parse("nasfn nfdsjan dkn afdsn ndsakn fdsa sdda", $pcm));
xassert_eqq($mpxs, []);
$mpxs = iterator_to_array(MentionParser::parse("@Mary@fart @Mary: @Deborah, @Peter Danzig---@Vera:", $pcm));
...
$mpxs = iterator_to_array(MentionParser::parse("@Peter\n   Danzig\n\n@Peter\n\nDanzig---@Vera", $pcm));
...
$mpxs = iterator_to_array(MentionParser::parse("@paul @päul @véra", $pcm));
xassert_eqq(count($mpxs), 2);
...
$mpxs = iterator_to_array(MentionParser::parse("oh that's @vera@bombay.com hello there", $pcm));
xassert_eqq(count($mpxs), 1);
xassert_eqq($mpxs[0][0]->email, "vera@bombay.com");
xassert_eqq($mpxs[0][1], 10);
xassert_eqq($mpxs[0][2], 26);
$mpxs = iterator_to_array(MentionParser::parse("Does @J. J. work? Does @Garcia-Luna-Aceves work?", $pcm));
xassert_eqq(count($mpxs), 2);
...
$mpxs = iterator_to_array(MentionParser::parse("Does @J.J. work?", $pcm));
xassert_eqq(count($mpxs), 1);
xassert_eqq($mpxs[0][0]->email, "jj@cse.ucsc.edu");
xassert_eqq($mpxs[0][1], 5);
xassert_eqq($mpxs[0][2], 10);
$mpxs = iterator_to_array(MentionParser::parse("a @Peter Danzig b @Peter c @Peter Druschel d", $pcm));
xassert_eqq(count($mpxs), 2);
xassert_eqq($mpxs[0][0]->email, "peter.danzig@usc.edu");
...
xassert_eqq($mpxs[1][1], 27);
xassert_eqq($mpxs[1][2], 42);
$user_pdanzig = $Conf->pc_member_by_email("PETER.DANZIG@usc.edu");
$mpxs = iterator_to_array(MentionParser::parse("a @Peter Danzig b @Peter c @Peter Druschel d", [$user_pdanzig], $pcm));
...
$user_pdruschel = $Conf->pc_member_by_email("pdruschel@cs.rice.edu");
$mpxs = iterator_to_array(MentionParser::parse("A @PETER DANZIG B @PETER C @PETER DRUSCHEL D", [$user_pdruschel], $pcm));
xassert_eqq(count($mpxs), 3);
xassert_eqq($mpxs[0][0]->email, "peter.danzig@usc.edu");
xassert_eqq($mpxs[0][1], 2);
xassert_eqq($mpxs[0][2], 15);

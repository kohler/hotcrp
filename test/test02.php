...
run_tests(new Unit_Tester($Conf));
...
run_tests(new XtCheck_Tester($Conf));
...
run_tests(new Navigation_Tester);
...
run_tests(new AuthorMatch_Tester);
...
run_tests(new IntlMsgSet_Tester);
...
run_tests(new Abbreviation_Tester($Conf));
...
run_tests(new DocumentBasics_Tester($Conf));
...
run_tests(new FixCollaborators_Tester);
...
run_tests(new Mention_Tester($Conf));

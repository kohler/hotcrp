...
if ($Me->privChair && $_REQUEST["t"] == "pc")
    ...
    $Conf->infoMsg("<p><a href='${ConfSiteBase}account.php?new=1' class='button'>Create account</a></p><p>Select an account name to edit account information.  Select <img src='${ConfSiteBase}images/viewas.png' alt='[Act as]' /> to view the site as someone else.</p>");

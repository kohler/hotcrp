...
if ($Me->privChair && $prow->conflictType > 0 && !$forceShow) {
    ...
    echo "<tr>\n  <td class='caption'></td>\n  <td class='entry'>", $a, $Conf->cacheableImage("override24.png", "[Override]", null, "dlimg"), "</a>&nbsp;", $a, "Override conflict</a> to see all comments and allow editing</a><div class='g' /></td>\n</tr>\n\n";
}

...
function doSubGroup() {
	...
	echo "<div class='g' /><table id='foldbanal' class='", ($Conf->setting("sub_banal") ? "foldo" : "foldc"), "'>";
...
function doOptGroup() {
	...
	foreach ($opt as $o) {
	    ...
	    $sep = "<tr><td></td><td><div class='g' /></td></tr>\n";
	}
    ...
    echo "<div class='g' /><table id='newtoptable'>";
